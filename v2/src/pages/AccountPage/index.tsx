...
import BlockTable, { Block } from '../../components/BlockTable';
...
export const AccountPage: React.FC = () => {
  ...
  const notFound = !agentLoading && !agentData?.agent;
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <p className="text-gray-600">The account address you're looking for doesn't exist.</p>
        </div>
      </div>
    );
  }
